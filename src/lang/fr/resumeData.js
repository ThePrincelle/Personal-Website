let resumeData = {
	...
	"moreme": [
		...
		},
		{
			...
			"text": "Le monde de l'informatique est en soi, pour moi, en demande constante de créativité. Malgré le fait que le langage soit commun, il ne faut selon mon avis, jamais arrêter d'innover afin de permettre à un logiciel ou un système de rester le plus innovant, le plus longtemps possible."
		},
		{
		...
		},
		{
			...
			"text": "Dans ce domaine, l'informatique, on ne doit jamais cesser d'apprendre, que ce soit de nouvelles méthodes de programmation ou tout simplement un nouveau langage, la personne qui apprends dans ce domaine, doit maintenir une veille technologique constante tout en continuant de s'améliorer en s'investissant au maximum dans un projet."
		}
	],
	"eduDesc": [
    ...
    "skills":[
		...
		},
		{
			...
			"type": "Logiciels de traitement de texte, de présentation, etc...",
			"text": [
				"J'utilise la suite Office depuis la version 2003.",
				"J'ai donc aujourd'hui, d'assez bonnes connaissances sur les logiciels Word, PowerPoint, Excel, Visio,..."
			]
		},
		{
			...
			"type": "Logiciel de graphisme",
			"text": [
				"J'utilise ce logiciel régulièrement afin de modifier ou de créer des images pour différentes occasions.",
				"Exemple : création de site web, d'interfaces, d'icônes, etc..."
			]
		},
		{
			"name": "Git",
	...
	"contactOther": "Me contacter",
	"formTitle": "M'envoyer un message.",
	"formNameLabel": "Votre nom",
	"formNamePlaceholder": "Insérez votre nom ici.",
	"formMailLabel": "Votre e-mail",
	"formMailPlaceholder": "Insérez votre e-mail ici.",
	"formSujetLabel": "Sujet",
	"formSujetPlaceholder": "Insérez ici l'objet de votre message",
	"formMsgLabel": "Message",
	"formMsgPlaceholder": "Insérez votre message ici.",
	"btnSend": "Envoyer",
	"emptyInputs": "Merci de remplir tous les champs.",
	"locCaptcha": "fr",
	"cvPDF_Msg": "CV en PDF",
	...
	"spamMsg": "Navré mais le service de vérification n'a pas confirmé l'envoi de votre message. Nous vous invitons à réessayer.",
