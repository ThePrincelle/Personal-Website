			...
			<div class="form-container">
				<div class="form">
					...
					<form id="contact-form">
						<div>
							<label style={{ color: "#FFF", fontSize: ".9rem" }} for="contact-name">{resumeData.formNameLabel}</label>
						...
						<div>
							<label style={{ color: "#FFF", fontSize: ".9rem" }} for="contact-email">{resumeData.formMailLabel}</label>
						...
						<div>
							<label style={{ color: "#FFF", fontSize: ".9rem" }} for="contact-subject">{resumeData.formSujetLabel}</label>
